...
- List YouTube live streams in channel feeds again (#109).
...
- Prioritize anonymous YouTube listing before browser cookies.

## v1.137.6 - 2026-09-24

- List YouTube channels through yt-dlp when their RSS feed fails.

## v1.137.5 - 2026-09-23

- Update SeleniumBase to 4.54.11.
...
- Match CI and updater signature checks to the self-signed release cert.

## v1.137.2 - 2026-09-23

- Stop metadata enrichment burning CPU and bound reader caches.

## v1.137.1 - 2026-09-18

- Keep the player responsive while a cast starts.
...
- Avoid repeated guide headings and Sky related links.

## v1.136.0 - 2026-09-12

- Translate offline user guide.
- Add an offline user guide with context-sensitive F1 help.
- Let the shortcut capture dialog keep F1.
...
- Preserve GSMArena battery table in Open Article.

## v1.135.1 - 2026-08-28

- Stop updates failing on the locked feed browser profile.
...
- Recover podcast history for all providers.
...
- Never let the translation override reset delete the shipped catalogs.

## v1.130.7 - 2026-08-21

- Refresh VoiceOver full text readers.
- Verify packaged runtime and full text.

## v1.130.6 - 2026-08-20

- Render iframe embeds inside the rich reader again.

## v1.130.5 - 2026-08-19

- Replace PowerShell VSS cookie recovery.

## v1.130.4 - 2026-08-16

- Keep YouTube feeds working when browser cookies are imported.
- Capture remote Linux directory reliably.
...
- Sync all locale catalogs with the current template.
- Merge PR #98: Fix Russian translation (@tseykovets).
- Fix Russian translation.

## v1.130.1 - 2026-08-13

- Never show a console window when importing cookies.
...
- Derive Chromium v20 cookie keys via a non-PPL SYSTEM token.

## v1.129.0 - 2026-08-13

- Import cookies from every installed browser, including Chromium v20.

## v1.128.3 - 2026-08-13

- Make Stop Refresh actually stop feed refreshing.

## v1.128.2 - 2026-08-13

- Read NPR articles and audio around the TollBit gate.

## v1.128.1 - 2026-08-12

- Survive transient GitHub 503s during update checks.
...
## v1.127.12 - 2026-08-08

- Read GitHub discussions in article views.
- Show whole GitHub pages in article views.

## v1.127.11 - 2026-08-01

- Restore Sky News Flourish tables in article views.

## v1.127.10 - 2026-08-01

- Recover current Sky News block footer.

## v1.127.9 - 2026-07-30

- Remove successful update temp files.

## v1.127.8 - 2026-07-30

- Prevent updater helper cleanup races.

## v1.127.7 - 2026-07-30

- Terminate orphaned update helpers.

## v1.127.6 - 2026-07-30

- Restore silence scan and enforce refresh breaker.

## v1.127.5 - 2026-07-30

- Harden refresh and media handling.

## v1.127.4 - 2026-07-30

- Complete plural translations.
- Update Russian translation.
- Add plural forms to gettext strings.
...
- Play YouTube radio links inside BlindRSS.

## v1.127.0 - 2026-07-30

- Self-update the embedded yt_dlp module at runtime.
- Retry yt-dlp downloads with the wider player-client fallback pool.

## v1.126.0 - 2026-07-29

- Add opt-in paid CAPTCHA solver as last-resort challenge escalation.
- Escalate challenge-blocked browser fetches to a driverless pydoll tier.
...
- Pin Linux wxPython binary build.
...
- Open Settings on General and stop the delay on OK.
- Fold five thin Settings tabs into the pages they belong to.

## v1.121.1 - 2026-07-24

- Open Settings about four times faster.

## v1.121.0 - 2026-07-24

- Deliver translation updates without an app release.
- Bundle translation update modules in frozen builds.

## v1.120.5 - 2026-07-24

- Stop stale article text sticking in the reader pane.

## v1.120.4 - 2026-07-24

- Complete YouTube Takeout translations in all 15 locales.
- Update Russian translation (#90).

## v1.120.3 - 2026-07-24

- Recover Sky News podcast content.

## v1.120.2 - 2026-07-24

- Reduce NVDA lag in YouTube readers.

## v1.120.1 - 2026-07-24

- Reduce long reader rendering lag.

## v1.120.0 - 2026-07-23

- Add complete YouTube full text.

## v1.119.2 - 2026-07-23

- Improve Takeout accessibility and large-account performance.

## v1.119.1 - 2026-07-23

- Bulk import Miniflux OPML.

## v1.119.0 - 2026-07-23

- Import YouTube Takeout subscriptions.
- Merge pull request #88 from tseykovets/ru.
- Update Russian translation.

## v1.118.0 - 2026-07-23

- Add Google forum support.

## v1.117.0 - 2026-07-23

- Add Groups.io support.
