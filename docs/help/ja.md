...
BlindRSS は再生しているものを、ネットワーク上の Chromecast、AirPlay スピーカー、DLNA/UPnP レンダラー、Sonos スピーカー、Roku プレーヤー、Kodi へ送れます。エピソードは再生していた位置からデバイス上で続き、一時停止・シーク・再生位置もローカルと同じように使えます（Roku はシークできません）。
