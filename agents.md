...
8. Releases: use `.\build.bat release` for Windows release builds; macOS release-asset publication may be dispatched from macOS with `./build.sh release <tag>` after the Windows-created release exists (details in `build.md`).
